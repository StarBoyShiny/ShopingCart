...
import com.ORGpro.ShopingCart.service.image.ImageService;
...
public class ImageController {
    ...
    public ResponseEntity<Resource> downloadImage(@PathVariable Long imageId) throws SQLException {
        ...
        ByteArrayResource resource = new ByteArrayResource(image.getImageData().getBytes(1, (int) image.getImageData().length()));
